...
import { searchClientAcademy } from "../src/searchClientAcademy";
import { MetaSearchPlugin } from "./types";

export function createAcademyPlugin(): MetaSearchPlugin<any, undefined> {
  return {
    getSources({ query }) {
      if (!query) {
        return [];
      ...
      return [
        {
          ...
          getItems() {
            return getAlgoliaResults({
              searchClient: searchClientAcademy,
              queries: [
                {
                  indexName: "Algolia_Academy",
                  query,
                  params: {
                    hitsPerPage: 3,
                  },
          ...
          components: {
            Header() {
              return (
                <div>
                  <span className="aa-SourceHeaderTitle">Academy</span>
